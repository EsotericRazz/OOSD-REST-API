...
--
-- Creation: Sep 17, 2024 at 02:31 PM
--
...
--
-- RELATIONSHIPS FOR TABLE `affiliations`:
--
...
--
-- RELATIONSHIPS FOR TABLE `agencies`:
--
...
(9, 'Brian', 'J.', 'Peterson', '(403) 210-7833', 'brian.peterson@travelexperts.com', 'Senior Agent', 1);
...
--
-- RELATIONSHIPS FOR TABLE `bookingdetails`:
--   `BookingId`
--       `bookings` -> `BookingId`
--   `RegionId`
--       `regions` -> `RegionId`
...
--
-- RELATIONSHIPS FOR TABLE `creditcards`:
--   `CustomerId`
--       `customers` -> `CustomerId`
--
...
(239, 'VISA', '2311240543980123', '2019-11-03 00:00:00', 114),
...
(283, 'AA', 'aaaaa', '2024-11-21 00:00:00', 117);
...
--
-- RELATIONSHIPS FOR TABLE `customers_rewards`:
--   `CustomerId`
--       `customers` -> `CustomerId`
--   `RewardId`
--       `rewards` -> `RewardId`
...
('POE', 'is the best', 5000.0000, 'Game Created Ever'),
...
(5, 'Foobar Excursion', '2024-11-20 00:00:00', '2024-11-30 00:00:00', 'Lorem Ipsum', 9001.0000, 9000.0000);
...
--
-- RELATIONSHIPS FOR TABLE `packages_products_suppliers`:
--   `ProductSupplierId`
...
--
-- RELATIONSHIPS FOR TABLE `products_suppliers`:
--   `ProductId`
--       `products` -> `ProductId`
--   `SupplierId`
...
--
-- Creation: Nov 18, 2024 at 08:42 PM
--

CREATE TABLE `subdivisions` (
  `SubdivisionCode` char(2) NOT NULL,
  `SubdivisionName` varchar(50) NOT NULL,
  `CountryName` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;

--
-- RELATIONSHIPS FOR TABLE `subdivisions`:
--
...
INSERT INTO `subdivisions` (`SubdivisionCode`, `SubdivisionName`, `CountryName`) VALUES
('AB', 'Alberta', 'Canada'),
...
--
-- RELATIONSHIPS FOR TABLE `suppliercontacts`:
--   `SupplierId`
--       `suppliers` -> `SupplierId`
--   `AffiliationId`
...
--
-- RELATIONSHIPS FOR TABLE `triptypes`:
--
...
ALTER TABLE `subdivisions`
  ADD PRIMARY KEY (`SubdivisionCode`);
...
--
ALTER TABLE `rewards`
  MODIFY `RewardId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
